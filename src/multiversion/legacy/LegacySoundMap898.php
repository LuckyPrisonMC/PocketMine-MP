...
/*
 * Sound mapping for protocol 898 (1.21.130), matching constant names between
 * bedrock-protocol 54.0.0 (1.21.130) and 58.0.0 (1.26.30). Same approach as
 * LegacySoundMap, but 1.21.130 has 538 sound constants vs 1.26.0's 557
 * (several sounds, e.g. spear attack sounds, weren't added until later).
 */

namespace pocketmine\multiversion\legacy;

final class LegacySoundMap898{
